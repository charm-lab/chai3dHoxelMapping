...
#include "trialFailNotification.h"

TrialFailNotification::TrialFailNotification(QWidget *parent) : QDialog(parent)
{
    ...
    connect(continueButton, &QPushButton::clicked, this, &TrialFailNotification::handleContinueButtonClick);
...
TrialFailNotification::~TrialFailNotification()
{

}

void TrialFailNotification::handleContinueButtonClick()
{
    close();
}

void TrialFailNotification::keyPressEvent(QKeyEvent *event)
{
