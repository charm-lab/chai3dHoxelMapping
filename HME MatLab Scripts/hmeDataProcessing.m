...
if (showInidividualSubjects == false)
    ...
    % Plot Significant Figure stars:
    plotHMESigStar("normal-shear");
...
% alpha = 0.05
% 
% [H, pValue, W] = swtest(reshape([meanIndexShearForceMapping5{:,p}],[],1), alpha)
...
%% Mean Number of Box Breaks: ************************************************
close all; clc;
disp("Mean Number of Box Breaks")
...
close all; clc;
disp("Total Number of Box Breaks")
