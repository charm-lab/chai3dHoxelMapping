%   Customized improvePlot script for FingerMappingExperiment figures
%**************************************************************************
function [] = improvePlot_v2(fullScreenBool, customSizeBool, fontSize, width, height)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % Plot parameters
    % Make figures full screen or custom size
    fullScreen = fullScreenBool;   
    customSize = customSizeBool;
    plot_width_in_px = width;
    plot_height_in_px = height;
...
%     marker_size = 20;
    ...
    %     fullscreen
    if(fullScreen == true)
    set(hFig, 'rend', 'painters', 'Units', 'pixels', 'pos', get(0, 'Screensize'),...
