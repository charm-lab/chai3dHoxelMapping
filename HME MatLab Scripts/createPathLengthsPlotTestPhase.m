...
errorbar(vec1(i),...
    ...
    "^", "MarkerFaceColor", str2num(colors(i)), ...
    "Color", str2num(colors(i)), "MarkerSize", markerSize, ...
    "LineWidth", 2); hold on;
% Thumb Testing
%h2 = 
errorbar(vec2(i), ...
    thumbP3.YData(i), thumbP3.YNegativeDelta(i), thumbP3.YPositiveDelta(i), ...
    "o", "MarkerFaceColor", str2num(colors(i)), ...
    "Color", str2num(colors(i)), "MarkerSize", markerSize, ...
    "LineWidth", 2);
...
errorbar(vec3(i), ...
    ...
    "s", "MarkerFaceColor", str2num(colors(i)), ...
    "Color", str2num(colors(i)), "MarkerSize", markerSize, ...
    "LineWidth", 2);
end
...
h1 = errorbar(0, 0, 0, 0, "^", "MarkerFaceColor","k", ...
    "Color", "k", "MarkerSize", markerSize, "LineWidth", 2);
h2 = errorbar(0, 0, 0, 0, "o", "MarkerFaceColor","k", ...
    "Color", "k", "MarkerSize", markerSize, "LineWidth", 2);
